...
import { EntregasStatusChart } from "./EntregasStatusChart";
import { useAuth } from "@/hooks/use-auth";
import { EntregasStatusDonutChart } from "./EntregasStatusDonutChart";

interface EntregasDashboardProps {
  selectedYear: string;
}

export const EntregasDashboard: React.FC<EntregasDashboardProps> = ({ selectedYear }) => {
      ...
      <div className="px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            <EntregasStatusChart selectedYear={selectedYear} />
          </div>

          {/* Right Column - Sidebar */}
          <div className="space-y-8">
            <EntregasStatusDonutChart selectedYear={selectedYear} />
          </div>
        </div>
      </div>
    </div>
