...
export type PestControlServiceRow = {
  ...
  status: string // Refers to pest_service_status enum
  service_date: string
  service_time: string | null
  pests_detected: Json | null // JSONB array of strings
  environment_type: string | null
  address: string
  checklist: Json | null // JSONB object
  observations: string | null
  attachments: Json | null // JSONB array of file attachments
