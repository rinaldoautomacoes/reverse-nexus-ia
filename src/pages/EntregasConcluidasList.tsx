...
import { ArrowLeft, Truck, Search, CheckCircle, Calendar as CalendarIcon, User, MapPin, Hash, Package, Building, MessageSquare, Send, Edit, Trash2, Clock, DollarSign, Tag, Home, Flag, ClipboardList, FileText, Paperclip } from "lucide-react";
                  ...
                  >
                    <div className="flex-1 min-w-0 mb-3 lg:mb-0">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-muted-foreground mt-1">
                        ...
                        <div className="flex items-center gap-1">
                          <CalendarIcon className="h-3 w-3" /> Concluída em: {entrega.previsao_coleta ? (isValid(new Date(entrega.previsao_coleta)) ? format(new Date(entrega.previsao_coleta), 'dd/MM/yyyy', { locale: ptBR }) : 'Data inválida') : 'N/A'}
                        </div>
                        <div className="flex items-center gap-1">
